...
calculate the entry j of this vector (i.e. 𝑤𝑗, that is, row 1 column j of the matrix weights) we first need to calculate the dispersion of the column j in the data matrix:
∆𝑗= ∑∑𝑢𝑖𝑘 (𝐷′𝑖𝑗 − 𝑐𝑘𝑗)^2
i=1-𝑛
𝑖=1-𝐾
𝑘=1
